...
import profilepic from "@/assets/steveluzong.jfif";
      ...
      <div className="section-container relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            ...
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="gradient-text">Steve Vincent Luzong</span>
            </h1>
          </motion.div>
          ...
          >
            ...
            <br />
            <br />I help businesses streamline operations through intelligent
            automation, CRM management, and AI-powered solutions. Let's reduce
            your manual tasks and scale your efficiency.
          </motion.p>
          ...
          >
            <a
              href="https://github.com/titoteban"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/steve-vincent-luzong-683022387/"
              target="_blank"
              rel="noopener noreferrer"
              className="social-icon"
            >
            ...
            <a
              href="mailto:stevevincentluzong@gmail.com"
              className="social-icon"
            >
              <Mail size={20} />
            </a>
          ...
          >
            ...
            <a
              href="https://drive.google.com/file/d/1NDDlzcLrL93S26PwyVfK5ApR9VkWlaau/view?usp=sharing"
              download="https://drive.google.com/file/d/1NDDlzcLrL93S26PwyVfK5ApR9VkWlaau/view?usp=sharing"
        ...
        >
          <div className="relative w-80 h-80 sm:w-96 sm:h-96 lg:w-[28rem] lg:h-[28rem]">
            ...
            {/* Image Container (Option C: Orbiting Ring) */}
            <motion.div
            ...
            >
              {/* Orbit ring */}
              <motion.div
                className="absolute -inset-3 rounded-[2.2rem] pointer-events-none"
                style={{
                  background:
                    "conic-gradient(from 0deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.0) 30%, rgba(255,255,255,0.35) 50%, rgba(255,255,255,0.0) 70%, rgba(255,255,255,0) 100%)",
                  filter: "blur(10px)",
                  opacity: 0.55,
                }}
                animate={{ rotate: 360 }}
