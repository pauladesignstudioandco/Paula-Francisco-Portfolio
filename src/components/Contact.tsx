      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Ready to automate your business? Let's discuss how I can help streamline your operations
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">stevevincentluzong@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">+63 960 560 1202</p>
                </div>
              </a>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/steve-vincent-luzong-683022387/" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Linkedin size={20} />
                </a>
                <a href="https://github.com/titoteban" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Github size={20} />
                </a>
                <a href="mailto:stevevincentluzong@gmail.com" className="social-icon">
                  <Mail size={20} />
                </a>
              </div>
            </div>
