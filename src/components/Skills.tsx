...
const skillCategories = [
  {
    ...
    skills: ['Zapier', 'n8n', 'Make (Integromat)'],
  },
  {
    title: 'AI & Automation',
    skills: ['ChatGPT', 'OpenAI API', 'AI Agents', 'Prompt Engineering'],
  },
  {
    title: 'No-Code / Low-Code',
    skills: ['Airtable', 'Google Sheets', 'Notion'],
  },
  {
    title: 'Task & Project Tools',
    skills: ['ClickUp', 'Trello', 'Asana'],
  },
  {
    title: 'Web & Forms',
    skills: ['Typeform', 'Jotform', 'Web Forms'],
  },
];
